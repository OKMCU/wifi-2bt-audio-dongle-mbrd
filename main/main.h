...
#define TASK_EVT_APP_MAIN_APP_EXCEPTION     6
#define TASK_EVT_APP_MAIN_HAL_EXCEPTION     7
#define TASK_EVT_APP_MAIN_OSAL_EXCEPTION    8
...
#define TASK_EVT_HAL_DRIVERS_LUCICMD_RXOVF  1
#define TASK_EVT_HAL_DRIVERS_LUCICMD_RXNE   2
#define TASK_EVT_HAL_DRIVERS_CLI_RXNE       3
#define TASK_EVT_HAL_DRIVERS_UIBRD_TRIG_IRQ 4
#define TASK_EVT_HAL_DRIVERS_LUCICMD_TXE    5
#define TASK_EVT_HAL_DRIVERS_CLI_TXE        6
#define TASK_EVT_HAL_DRIVERS_UIBRD_POLL_IRQ 7

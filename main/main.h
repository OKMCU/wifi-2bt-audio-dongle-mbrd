...
#define TASK_EVT_APP_MAIN_APP_EXCEPTION     5
#define TASK_EVT_APP_MAIN_HAL_EXCEPTION     6
#define TASK_EVT_APP_MAIN_OSAL_EXCEPTION    7
...
#define TASK_EVT_HAL_DRIVER_WIFIMOD_HN_TIMEOUT  3
#define TASK_EVT_HAL_DRIVER_WIFIMOD_SRC_CTRL    4
